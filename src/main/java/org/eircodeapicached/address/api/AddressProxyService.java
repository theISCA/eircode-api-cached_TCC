...
public class AddressProxyService {
  ...
  @RequestMapping(
      path = "/pcw/{apiKey}/address/{country}/{eircodeOrAddressFrag}",
  ...
  public ResponseEntity<String> address(
    ...
    if (REQ_PARAM_MOCK_MODE_PARAM.equals(mockMode)) {
      log.debug(
          "Request parameter mockMode=param detected. Using ParamCheckMock client to render response.");
      response =
          paramCheckMockClient.address(
              apiKey,
              country,
