...
public class AddressURIBuilder {
  ...
  public URI generateAddressURIFromUrl(
  ...
  public URI generateAddressURIFromPath(
      @NotNull String baseUrl,
      @NotNull String apiKey,
      @NotNull String country,
      String eircodeOrAddressFrag,
  ...
  private URI generate(
    ...
    if (postcodeonly != null && "ie".equals(country))
      builder.queryParam("postcodeonly", postcodeonly);
