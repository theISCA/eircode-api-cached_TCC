...
/**
 * Just echoes back relevant path, request parameters and request headers received Allows to check
 * if parameters are being received and managed correctly.
 *
 * <p>Useful for testing REST Webservice without having to call Postcoder service.
 *
 * @author Rodrigo
 */
@Component("paramCheckMockClient")
@Validated
public class PostcoderAddressParamCheckMockClient implements PostcoderAddressClient {
